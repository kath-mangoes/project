...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    //var_dump($_POST['comp_desc']);
    //exit;
    $insertQuery = "INSERT INTO tbl_compgriev (res_id, user_id, dateFiled, caseNumber, complainant, 
                   respondent, victim, witness, natureOfCase, comp_desc, actionTaken, brgyOfficer_id, 
    ...
    if ($insertStmt->execute()) {
        ...
        header("Location: barangay-complain.php?success=1");
        exit();
    } else {
        // Redirect with error parameter
        header("Location: barangay-complain.php?error=1&message=" . urlencode($conn->error));
        exit();
    }
