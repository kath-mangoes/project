...
<head>
    ...
    <title>Banragay Complaints and Blotter</title>
...
<body>
    ...
    <section class="hero">
        <div class="hero-banner">
            ...
            <div class="hero-text">
                <h1>Barangay Blotter and Complaints</h1>
        ...
        <div class="certification-container">
            <div class="category-card">
                <div class="cert-card-container">
                    ...
                    $query = "SELECT * FROM web_services WHERE category = 'Barangay Blotter and Complaint'";
