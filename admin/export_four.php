...
function exportExcel($result, $currentDate) {
    ...
    $spreadsheet->getProperties()
        ...
        ->setTitle('4ps Residents')
        ->setSubject('4ps Residents Report')
        ->setDescription('4ps Residents information from Barangay 400 Management System');
    ...
    $sheet->setCellValue('C2', '4ps RESIDENTS INFORMATION REPORT');
    ...
    $headers = [
        ...
        'Q' => 'Senior', 'R' => 'PWD', 'S' => 'Account Status'
    ];
    ...
    while ($data = $result->fetch_assoc()) {
        ...
        $sheet->setCellValue('R' . $row, $data['is_pwd']);
    ...
    $sheet->setTitle('4ps Residents');

    // Output
    $filename = 'Barangay400_4ps_Residents_' . $currentDate . '.xlsx';
