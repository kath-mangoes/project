...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($cert_result->num_rows > 0) {
        ...
        if ($stmt->execute()) {
            ...
            $audit_stmt->bind_param("siisssssss", $certification_user_id, $brgyOfficer_id, $res_id, $certificateType, $role, $details, $processedBy, $currentDateTime, $audit_status, $currentDateTime);
            $audit_stmt->execute();
            $audit_stmt->close();
